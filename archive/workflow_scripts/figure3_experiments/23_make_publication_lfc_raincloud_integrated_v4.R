...
# Tiny baseline offset keeps both density outlines visible.
density_baseline <- c(
  "Ophiostoma" = 2.30,
  "Fusarium" = 2.27
)
...
p_integrated <- ggplot() +
  ...
  make_density_layer(
    ...
    baseline = density_baseline[["Ophiostoma"]],
    x_max = shared_p99,
  ...
  make_density_layer(
    ...
    baseline = density_baseline[["Fusarium"]],
    x_max = shared_p99,
    adjust = density_adjust,
    height = density_height,
    alpha = density_alpha
...
ggsave(
  file.path(
    output_dir,
    "figure3D_raincloud_integrated_v4.pdf"
  ),
  p_integrated,
  width = 5.2,
  height = 3.15,
...
ggsave(
  file.path(
    output_dir,
    "figure3D_raincloud_integrated_v4.png"
  ),
  p_integrated,
  width = 5.2,
  height = 3.15,
...
message("\nGenerated integrated comparison panel:")
message("  figure3D_raincloud_integrated_v4.pdf")
message("  figure3D_raincloud_integrated_v4.png")
message("\nFiles written to:")
message("  ", output_dir)
