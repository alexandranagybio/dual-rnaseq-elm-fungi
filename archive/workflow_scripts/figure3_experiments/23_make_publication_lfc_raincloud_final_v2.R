...
# -------------------------------------------------------------------------
# Build density polygons manually.
#
# This avoids orientation problems and gives exact vertical control:
# cloud above, boxplot in the middle, rain below.
# -------------------------------------------------------------------------
...
ggsave(
  file.path(output_dir, "figure3D_raincloud_final_v2.pdf"),
  p_final,
  width = 5.0,
  height = 3.0,
  units = "in",
...
ggsave(
  file.path(output_dir, "figure3D_raincloud_final_v2.png"),
  p_final,
  width = 5.0,
  height = 3.0,
  units = "in",
...
message("\nGenerated corrected raincloud panel:")
message("  figure3D_raincloud_final_v2.pdf")
message("  figure3D_raincloud_final_v2.png")
message("\nFiles written to:")
message("  ", output_dir)
